...
function QueEstaPasando() {
  return (<div className="max-w-[330px] h-[510px] dark:bg-[#16181C] rounded-xl">
    <div className="flex flex-col gap-3 p-3">
      ...
      <div className="dark:text-white hover:bg-blue-100/10 transition-all duration-300 rounded-md cursor-pointer p-1">
        <p className="text-gray-500 text-sm">Tendencia en Argentina</p>
        <p>#lluvia </p>
        <p className="text-gray-500 text-sm">3,4 mil Tweets</p>
      </div>
      <div className="dark:text-white hover:bg-blue-100/10 rounded-md cursor-pointer p-1 transition-all duration-30">
