...
const Modal = () => {
  ...
  return (
        <div className='fixed top-0 left-0 bottom-0 rigth-0 z-[99999] h-screen w-screen bg-[#242d34bb]' onClick={closeModal}>

            <div className='bg-black w-[350px] max-[640px]:w-full max-[640px]:h-full md:w-[650px] text-white absolute left-[50%] translate-x-[-50%] mt-[40px] max-[640px]:mt-0 p-4 rounded-[20px]'
                ...
                <div className='relative mt-8 grid grid-cols-[48px,1fr] gap-4 '>
                    ...
                    <div>
                        ...
                        <p className='text-[12px] md:text-[16px]'>{post.content}</p>
